        ...
        <div class="col-sm-6 col-md-8">
            ...
            <div class="card card-user">
                    <div class="card-header card-header-user">
                            <h3><strong>Add New Signed Lease</strong></h3>                        
                    </div>

                    <div class="card-body">
                        <form  method="POST" action="{{ route('document.submit') }}" class="needs-validation report-form-public"  enctype="multipart/form-data" novalidate>
                            @csrf                           
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Tenant Name" id="signed_by" name="signed_by" required>                                
                                <div class="valid-feedback">Valid.</div>
                                <div class="invalid-feedback">Please fill out this field.</div>
                            </div>
                            <div class="input-group mb-3">                                
                            <div class="input-group-append">
                                    <span class="input-group-text">Add Signed Lease</span>
                                </div>
